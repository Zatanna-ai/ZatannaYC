...
interface CompanyFoundersModalProps {
  isOpen: boolean
  onClose: () => void
  companyName: string
}

export function CompanyFoundersModal({ isOpen, onClose, companyName }: CompanyFoundersModalProps) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div>
            <h2 className="text-section font-serif">Founders at {companyName}</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {!loading && !error && founders.length === 0 && (
            <div className="text-center py-12">
              <p className="text-body text-muted-foreground">No founders found for this company</p>
            </div>
          )}
        </div>
      </div>
